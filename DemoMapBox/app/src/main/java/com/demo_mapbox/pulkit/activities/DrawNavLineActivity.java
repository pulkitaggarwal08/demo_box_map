...
public class DrawNavLineActivity extends AppCompatActivity implements
    ...
    private Marker originMarker, destinationMarker, latlngMarker;
    private LatLng originlatLng, destinationlatLng, latlng;
    ...
    private Point originPosition, destinationPosition, latlngPostition;
    ...
    private void findIds() {
        ...
        startNavigation = findViewById(R.id.btn_start_navigation);
    }
...
//                icon = IconFactory.getInstance(DrawNavLineActivity.this)
//                        .fromResource(R.drawable.purple_marker);
//                        .getBitmap().createBitmap();

//                latlngMarker = mapboxMap.addMarker(new MarkerOptions()
//                        .position(point)
//                        .icon(icon));
            }
        });
...
//        directions.enqueueCall(this);
    ...
    private void startNavigation() {
        ...
        /*These below origin and destination points working correctly in navigation,
        * and also icon starts from origin*/
//        Point origin = Point.fromLngLat(76.709641, 28.616396);
//        Point destination = Point.fromLngLat(76.720788, 28.618722);

        //Todo: get location on selection on map.
//        Point origin = Point.fromLngLat(
//                originlatLng.getLongitude(), originlatLng.getLatitude());
//        Point destination = Point.fromLngLat(
//                destinationlatLng.getLongitude(), destinationlatLng.getLatitude());

        Point origin = originPosition = Point.fromLngLat(
                originlatLng.getLongitude(), originlatLng.getLatitude());
        Point destination = destinationPosition = Point.fromLngLat(
                destinationlatLng.getLongitude(), destinationlatLng.getLatitude());

        String awsPoolId = null;
        boolean simulateRoute = true;

        NavigationLauncher.startNavigation(DrawNavLineActivity.this,
